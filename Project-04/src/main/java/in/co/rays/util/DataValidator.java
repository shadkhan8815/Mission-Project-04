 ...
 * Provides methods to check nulls, numbers, email, name, roll number,
 * password, phone number, dates, and Sundays.
 * 
 * @author 
 */
public class DataValidator {
    ...
    /**
     * Checks if a string is a valid name (letters with optional spaces, dots, hyphens).
     * 
     * @param val the input string
    ...
    /**
     * Checks if a string is a valid roll number (two letters followed by three digits).
     * 
     * @param val the input string
    ...
    /**
     * Checks if a string is a valid password (8–12 characters with at least one digit, 
    ...
    /**
     * Checks if a string length is between 8 and 12 characters.
     * 
     * @param val the input string
    ...
    /**
     * Checks if a string is a valid phone number (10 digits starting with 6–9).
     * 
     * @param val the input string
    ...
    /**
     * Checks if a phone number string is exactly 10 digits.
     * 
     * @param val the input string
     * @return true if valid length, false otherwise
     */
    ...
    /**
     * Checks if a string is a valid date using DataUtility.
     * 
    ...
    /**
     * Main method to test all validation methods.
     * 
