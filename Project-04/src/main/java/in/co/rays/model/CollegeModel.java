...
//-----------------------------------------------------------------------------------
	...
	public long add (CollegeBean bean) throws ApplicationException, SQLException, DatabaseException, DuplicateRecordException, RecordNotFoundException {
...
//-----------------------------------------------------------------------	
	public void update(CollegeBean bean) throws DatabaseException, DuplicateRecordException, SQLException, RecordNotFoundException {
...
//------------------------------------------------------------------------------------------
	...
	public List search (CollegeBean bean, int pageNo, int pageSize) throws RecordNotFoundException, Exception{
...
//-----------------------------------------------------------------
	...
	public CollegeBean findByPk(long id) throws RecordNotFoundException, Exception {
...
//---------------------------------------------------------------------
	...
	public CollegeBean findByName(String name) throws RecordNotFoundException {
