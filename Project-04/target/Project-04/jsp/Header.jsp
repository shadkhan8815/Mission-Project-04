...
<body>
	...
	<a href="<%=ORSView.GET_MARKSHEET_CTL%>">GetMarksheet List</a> |
	<a href="<%=ORSView.MARKSHEET_MERIT_LIST_CTL%>">Marksheet MeritList</a>|
	...
	<table width="100%" style="border-collapse: collapse;">
		<tr>
			<td style="text-align: left; vertical-align: middle;">
				<h3>Hi, Guest</h3> <a href="<%=ORSView.WELCOME_CTL%>"><b>Welcome</b></a>
